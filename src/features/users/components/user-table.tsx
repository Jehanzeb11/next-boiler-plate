...
export function UserTable() {
  ...
  const getRoleBadge = (r: User["role"]) => {
    switch (r) {
      case "admin":
        return (
          <Badge className="bg-purple-100 dark:bg-purple-950/70 text-purple-700 dark:text-purple-300 border-purple-200 dark:border-purple-800/60 font-semibold px-2.5 py-0.5 rounded-full">
            Admin
          </Badge>
        )
      case "manager":
